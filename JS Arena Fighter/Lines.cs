...
{
    class Lines         //This class stores entries for randomized dialogue. To add more content, just add more entries - the game autotracks array sizes.
    {
        ...
        public static string[] retire = { "you have chosen to retire to spend more time with your remaining limbs.", "you've decided to let the younger generation a chance for glory.", "you want to focus more on your other hobby: not dying.", "the pain, suffering and carnage has left you a hollow shell of a human, and you cannot go on any longer.", "your old job is rehiring and you decide to give it another shot." };
        ...
        public static string GetDeadliness(int damage)
        {
            string deadliness = "";
            if (damage <= 0)
            {
